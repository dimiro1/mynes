...
public class TilesViewerPanel extends JPanel {
    ...
    /**
     * Refresh all individual tiles on the screen.
     */
    public void refresh() {
    ...
    private Rectangle getTilePosition(final int tileNumber) {
        ...
        int i = arrangement.indexOf(tileNumber);
    ...
    private void selectTile(final TileComponent tile) {
        ...
        listeners.forEach(l -> l.selectedTileChanged(selectedTile));
    }
}
